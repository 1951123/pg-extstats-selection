...
an \emph{exactly linear} MILP under the singleton-effect restriction, and
...
Protocol-M relies on the system-catalog layout and the planner's OID-order
...
it removes run-to-run drift (reproducible, CV~$0$), avoids \emph{empty}
